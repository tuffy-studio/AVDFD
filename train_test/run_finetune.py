import argparse
import os
from traintest_finetune import train
import torch
...
from dataloader.dataset_ft import FinetuneTrainDataset, FinetuneTestDataset
...
# 训练超参数 
m_res = 224
audio_conf = {'num_mel_bins': 128, 'target_length': args.target_length, 'freqm': args.freqm, 'timem': args.timem, 'mode':'eval', 
...
# =========================创建Dataloader============================
train_loader = DataLoader(FinetuneTrainDataset(args.data_train, audio_conf, stage=2), batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers, pin_memory=True, drop_last=True)
val_loader = DataLoader(FinetuneTestDataset(args.data_val, val_audio_conf, stage=2), batch_size=args.batch_size, shuffle=False, num_workers=args.num_workers, pin_memory=True, drop_last=True)
